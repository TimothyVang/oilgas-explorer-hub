      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-8">
        <div className="grid gap-8 md:grid-cols-[1fr_2fr] md:items-center">
          ...
          <div className="flex flex-wrap gap-4 md:justify-end">
            {[
              ...
              <a key={label} href={href} className="font-mono text-xs font-bold uppercase tracking-[-0.02em] underline decoration-2 underline-offset-4 transition-transform hover:translate-x-2">
                {label}
              </a>
            ))}
          </div>
        ...
        <div className="mt-8 flex flex-col gap-3 border-t-2 border-secondary pt-5 font-mono text-xs font-bold uppercase tracking-[-0.02em] md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-4">
            {siteConfig.social.linkedin && <a href={siteConfig.social.linkedin} className="hover:underline">LinkedIn</a>}
            <a href={`mailto:${siteConfig.contact.email}`} className="hover:underline">Email</a>
