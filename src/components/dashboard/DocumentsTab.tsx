      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {documents.length === 0 ? (
          <div className="col-span-full py-12 text-center text-gray-500">
            ...
            <p className="text-gray-400 mb-2">No documents assigned yet.</p>
            <p className="text-sm text-gray-500">Documents will appear here once an administrator assigns them to you.</p>
          </div>
        ) : (
