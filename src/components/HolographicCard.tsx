    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                variants[variant],
                "hover:shadow-[0_8px_40px_-12px_rgba(0,200,255,0.25)]",
        ...
        >
            ...
            <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none">
                <div className="absolute inset-[-1px] rounded-3xl bg-gradient-to-r from-primary/50 via-accent/30 to-primary/50 blur-sm" />
            </div>

            {/* Inner glass effect */}
            <div className="absolute inset-[1px] rounded-[22px] bg-gradient-to-br from-slate-900/90 to-slate-950/95 pointer-events-none" />
