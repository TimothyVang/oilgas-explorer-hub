...
export const demoInvestorDocuments: DemoInvestorDocument[] = [
  ...
  },
  {
    ...
    title: "Jackson Sands Deal Snapshot",
    description: "Concise investor snapshot covering structure, review sequence, and the core private materials staged for the BAH deal room.",
    created_at: "2026-05-24T00:00:00Z",
    category: "pitch",
    asset_type: "document",
    file_size: 75 * 1024,
    mime_type: "application/pdf",
    original_filename: "BAH Oil - Jackson Sands Deal Snapshot.pdf",
    thumbnail_path: null,
    sort_order: 1,
    is_featured: false,
  },
  {
    id: "demo-pitch-deck",
    title: "Jackson Sands Pitch Deck",
    ...
    mime_type: "application/pdf",
    original_filename: "BAH Oil - Jackson Sands Pitch Deck.pdf",
    thumbnail_path: null,
    sort_order: 2,
    is_featured: false,
  },
  {
    ...
    original_filename: "AFE - Investor Print.xlsx",
    thumbnail_path: null,
    sort_order: 1,
    is_featured: false,
  },
  {
    ...
    file_size: 191 * 1024,
    mime_type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    original_filename: "Pro Forma - Investor Locked Cells.xlsx",
    thumbnail_path: null,
    sort_order: 2,
    is_featured: false,
  },
  {
    ...
    file_size: 6 * 1024,
    mime_type: "application/pdf",
    original_filename: "Economic Summary.pdf",
    thumbnail_path: null,
    sort_order: 3,
    is_featured: false,
  },
  {
    ...
    mime_type: "application/pdf",
    original_filename: "Jackson Mapping Deck.pdf",
    thumbnail_path: null,
    sort_order: 1,
    is_featured: false,
  },
  ...
  },
  {
    ...
    file_size: 221 * 1024,
    mime_type: "application/pdf",
    original_filename: "Bryant Mook CV.pdf",
    thumbnail_path: null,
    sort_order: 1,
    is_featured: false,
  },
